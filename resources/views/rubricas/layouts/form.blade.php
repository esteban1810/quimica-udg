    ...
    <div class="container">
        ...
        <div class="col-3">
            <div class="campo">
                ...
                value="{{old('apellido_paterno_evaluador') ?? $modelRubrica->apellido_paterno_evaluador}}"
            ...
            <div class="campo">
                ...
                value="{{old('apellido_materno_evaluador') ?? $modelRubrica->apellido_materno_evaluador}}"
                @if($accion=='show') readonly @endif>
            </div>
            <div class="campo">
                ...
                value="{{old('nombre_evaluador') ?? $modelRubrica->nombre_evaluador}}"
                @if($accion=='show') readonly @endif>
            </div>
        </div>
        <div class="campo">
            ...
            value="{{old('correo') ?? $modelRubrica->correo}}"
            TODO: DESCOMENTAR Y ELIMINAR
            {{-- @if($accion=='show') readonly @endif> --}}
            @if($accion=='show') readonly @endif>
        </div>
        <div class="campo">
            @php($isProfesor = old('is_profesor') ?? $modelRubrica->is_profesor)
            ...
            @if($isProfesor=='SÍ') checked @endif @if($accion=='show') disabled @endif>Sí</label>
            <label for="Alumno">
            <input type="radio" name="is_profesor" value="NO" id="Alumno" onclick="visible('.s-3',true);add_req_insti();" 
            @if($isProfesor=='NO') checked @endif @if($accion=='show') disabled @endif>No</label>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-2">
            <div class="campo">
                ...
                value="{{old('nombre_institucion') ?? $modelRubrica->nombre_institucion}}"
                @if($accion=='show') readonly @endif>
            </div>
            <div class="campo">
                ...
                value="{{old('area_investigacion') ?? $modelRubrica->area_investigacion}}"
                @if($accion=='show') readonly @endif>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="campo">
            ...
            <input type="text" name="codigo" id="codigo" onKeyPress="if(this.value.length==10) return false;" placeholder="Código UdeG"
                value="{{old('codigo') ?? $modelRubrica->codigo}}"
                @if($accion=='show') readonly @endif>
        </div>
        <div class="campo">
            ...
            value="{{old('area_investigacion_proyecto') ?? $modelRubrica->area_investigacion_proyecto}}"
            @if($accion=='show') readonly @endif>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <h2 class="center">Datos del Estudiante a evaluar</h2>
            ...
            <div class="campo">
                ...
                value="{{old('id_trabajo') ?? $modelRubrica->id_trabajo}}"
                @if($accion=='show') readonly @endif>
            </div>
        <div class="col-3">
            <div class="campo">
                ...
                value="{{old('apellido_paterno_estudiante') ?? $modelRubrica->apellido_paterno_estudiante}}"
                @if($accion=='show') readonly @endif>
            </div>
            <div class="campo">
                ...
                value="{{old('apellido_materno_estudiante') ?? $modelRubrica->apellido_materno_estudiante}}"
                @if($accion=='show') readonly @endif>
            </div>
            <div class="campo">
                ...
                value="{{old('nombre_estudiante') ?? $modelRubrica->nombre_estudiante}}"
                @if($accion=='show') readonly @endif>
            </div>
        </div>
    </div>
...
<section class="seccion s-116">
    <div class="container">
        ...
        @php($isFormal = old('is_formal') ?? $modelRubrica->is_formal)
        <div class="grid-tabla-ap">
            ...
            <div><input type="radio" name="is_formal" id="is_formal_si" value="2"
                @if($isFormal=='2') checked @endif @if($accion=='show') disabled @endif><label for="is_formal_si">Sí</label></div>
            <div><input type="radio" name="is_formal" id="is_formal_no" value="0"
                @if($isFormal=='0') checked @endif @if($accion=='show') disabled @endif><label for="is_formal_no">No</label></div>
        </div>
        @php($isPuntual = old('is_puntual') ?? $modelRubrica->is_puntual)
        <div class="grid-tabla-ap">
            ...
            <div><input type="radio" name="is_puntual" id="is_puntualSi" value="2"
                @if($isPuntual=='2') checked @endif @if($accion=='show') disabled @endif><label for="is_puntualSi">Sí</label></div>
            <div><input type="radio" name="is_puntual" id="is_puntualNo" value="0"
                @if($isPuntual=='0') checked @endif @if($accion=='show') disabled @endif><label for="isPuntualNo">No</label></div>
        </div>
    </div>
</section>
...
<section>
    <div class="container">
        ...
        @php($rubrica21 = old('rubrica21') ?? $modelRubrica->rubrica21)
        <div class="grid-tabla">
            ...
            <div><input type="radio" name="rubrica21" id="rubrica215" value="5"
                @if($rubrica21=='5') checked @endif @if($accion=='show') disabled @endif><label for="rubrica215" >Excelente</label></div>
            <div><input type="radio" name="rubrica21" id="rubrica214" value="4"
                @if($rubrica21=='4') checked @endif @if($accion=='show') disabled @endif><label for="rubrica214">Muy Bueno</label></div>
            <div><input type="radio" name="rubrica21" id="rubrica213" value="3"
                @if($rubrica21=='3') checked @endif @if($accion=='show') disabled @endif><label for="rubrica213">Aceptable</label></div>
            <div><input type="radio" name="rubrica21" id="rubrica212" value="2"
                @if($rubrica21=='2') checked @endif @if($accion=='show') disabled @endif><label for="rubrica212">Regular</label></div>
            <div><input type="radio" name="rubrica21" id="rubrica211" value="1"
                @if($rubrica21=='1') checked @endif @if($accion=='show') disabled @endif><label for="rubrica211">Malo</label></div>
        </div>
        @php($rubrica22 = old('rubrica22') ?? $modelRubrica->rubrica22)
        <div class="grid-tabla">
            @if ($rubrica==1)
            ...
            <div><input type="radio" name="rubrica22" id="rubrica225" value="5"
                @if($rubrica22=='5') checked @endif @if($accion=='show') disabled @endif><label for="rubrica225">Excelente</label></div>
            <div><input type="radio" name="rubrica22" id="rubrica224" value="4"
                @if($rubrica22=='4') checked @endif @if($accion=='show') disabled @endif><label for="rubrica224">Muy Bueno</label></div>
            <div><input type="radio" name="rubrica22" id="rubrica223" value="3"
                @if($rubrica22=='3') checked @endif @if($accion=='show') disabled @endif><label for="rubrica223">Aceptable</label></div>
            <div><input type="radio" name="rubrica22" id="rubrica222" value="2"
                @if($rubrica22=='2') checked @endif @if($accion=='show') disabled @endif><label for="rubrica222">Regular</label></div>
            <div><input type="radio" name="rubrica22" id="rubrica221" value="1"
                @if($rubrica22=='1') checked @endif @if($accion=='show') disabled @endif><label for="rubrica221">Malo</label></div>
        </div>
        @php($rubrica23 = old('rubrica23') ?? $modelRubrica->rubrica23)
        <div class="grid-tabla">
            @if ($rubrica==1)
            ...
            <div><input type="radio" name="rubrica23" id="rubrica235" value="5"
                @if($rubrica23=='5') checked @endif @if($accion=='show') disabled @endif><label for="rubrica235">Excelente</label></div>
            <div><input type="radio" name="rubrica23" id="rubrica234" value="4"
                @if($rubrica23=='4') checked @endif @if($accion=='show') disabled @endif><label for="rubrica234">Muy Bueno</label></div>
            <div><input type="radio" name="rubrica23" id="rubrica233" value="3"
                @if($rubrica23=='3') checked @endif @if($accion=='show') disabled @endif><label for="rubrica233">Aceptable</label></div>
            <div><input type="radio" name="rubrica23" id="rubrica232" value="2"
                @if($rubrica23=='2') checked @endif @if($accion=='show') disabled @endif><label for="rubrica232">Regular</label></div>
            <div><input type="radio" name="rubrica23" id="rubrica231" value="1"
                @if($rubrica23=='1') checked @endif @if($accion=='show') disabled @endif><label for="rubrica231">Malo</label></div>
        </div>
        @php($rubrica24 = old('rubrica24') ?? $modelRubrica->rubrica24)
        <div class="grid-tabla">
            @if ($rubrica==1)
            ...
            <div><input type="radio" name="rubrica24" id="rubrica245" value="5"
                @if($rubrica24=='5') checked @endif @if($accion=='show') disabled @endif><label for="rubrica245">Excelente</label></div>
            <div><input type="radio" name="rubrica24" id="rubrica244" value="4"
                @if($rubrica24=='4') checked @endif @if($accion=='show') disabled @endif><label for="rubrica244">Muy Bueno</label></div>
            <div><input type="radio" name="rubrica24" id="rubrica243" value="3"
                @if($rubrica24=='3') checked @endif @if($accion=='show') disabled @endif><label for="rubrica243">Aceptable</label></div>
            <div><input type="radio" name="rubrica24" id="rubrica242" value="2"
                @if($rubrica24=='2') checked @endif @if($accion=='show') disabled @endif><label for="rubrica242">Regular</label></div>
            <div><input type="radio" name="rubrica24" id="rubrica241" value="1"
                @if($rubrica24=='1') checked @endif @if($accion=='show') disabled @endif><label for="rubrica241">Malo</label></div>
        </div>
        @php($rubrica25 = old('rubrica25') ?? $modelRubrica->rubrica25)
        <div class="grid-tabla">
            ...
            <div><input type="radio" name="rubrica25" id="rubrica255" value="5"
                @if($rubrica25=='5') checked @endif @if($accion=='show') disabled @endif><label for="rubrica255">Excelente</label></div>
            <div><input type="radio" name="rubrica25" id="rubrica254" value="4"
                @if($rubrica25=='4') checked @endif @if($accion=='show') disabled @endif><label for="rubrica254">Muy Bueno</label></div>
            <div><input type="radio" name="rubrica25" id="rubrica253" value="3"
                @if($rubrica25=='3') checked @endif @if($accion=='show') disabled @endif><label for="rubrica253">Aceptable</label></div>
            <div><input type="radio" name="rubrica25" id="rubrica252" value="2"
                @if($rubrica25=='2') checked @endif @if($accion=='show') disabled @endif><label for="rubrica252">Regular</label></div>
            <div><input type="radio" name="rubrica25" id="rubrica251" value="1"
                @if($rubrica25=='1') checked @endif @if($accion=='show') disabled @endif><label for="rubrica251">Malo</label></div>
        </div>
    </div>
</section>
...
<section>
    <div class="container">
        ...
        @php($rubrica31 = old('rubrica31') ?? $modelRubrica->rubrica31)
        <div class="grid-tabla">
            @if ($rubrica==1)
            ...
            <div><input type="radio" name="rubrica31" id="rubrica315" value="5"
                @if($rubrica31=='5') checked @endif @if($accion=='show') disabled @endif><label for="rubrica315">Excelente</label></div>
            <div><input type="radio" name="rubrica31" id="rubrica314" value="4"
                @if($rubrica31=='4') checked @endif @if($accion=='show') disabled @endif><label for="rubrica314">Muy Bueno</label></div>
            <div><input type="radio" name="rubrica31" id="rubrica313" value="3"
                @if($rubrica31=='3') checked @endif @if($accion=='show') disabled @endif><label for="rubrica313">Aceptable</label></div>
            <div><input type="radio" name="rubrica31" id="rubrica312" value="2"
                @if($rubrica31=='2') checked @endif @if($accion=='show') disabled @endif><label for="rubrica312">Regular</label></div>
            <div><input type="radio" name="rubrica31" id="rubrica311" value="1"
                @if($rubrica31=='1') checked @endif @if($accion=='show') disabled @endif><label for="rubrica311">Malo</label></div>
        </div>
        @php($rubrica32 = old('rubrica32') ?? $modelRubrica->rubrica32)
        <div class="grid-tabla">
            @if ($rubrica==1)
            ...
            <div><input type="radio" name="rubrica32" id="rubrica325" value="5"
                @if($rubrica32=='5') checked @endif @if($accion=='show') disabled @endif><label for="rubrica325">Excelente</label></div>
            <div><input type="radio" name="rubrica32" id="rubrica324" value="4"
                @if($rubrica32=='4') checked @endif @if($accion=='show') disabled @endif><label for="rubrica324">Muy Bueno</label></div>
            <div><input type="radio" name="rubrica32" id="rubrica323" value="3"
                @if($rubrica32=='3') checked @endif @if($accion=='show') disabled @endif><label for="rubrica323">Aceptable</label></div>
            <div><input type="radio" name="rubrica32" id="rubrica322" value="2"
                @if($rubrica32=='2') checked @endif @if($accion=='show') disabled @endif><label for="rubrica322">Regular</label></div>
            <div><input type="radio" name="rubrica32" id="rubrica321" value="1"
                @if($rubrica32=='1') checked @endif @if($accion=='show') disabled @endif><label for="rubrica321">Malo</label></div>
        </div>
        @php($rubrica33 = old('rubrica33') ?? $modelRubrica->rubrica33)
        <div class="grid-tabla">
            @if ($rubrica==1)
            ...
            <div><input type="radio" name="rubrica33" id="rubrica335" value="5"
                @if($rubrica33=='5') checked @endif @if($accion=='show') disabled @endif><label for="rubrica335">Excelente</label></div>
            <div><input type="radio" name="rubrica33" id="rubrica334" value="4"
                @if($rubrica33=='4') checked @endif @if($accion=='show') disabled @endif><label for="rubrica334">Muy Bueno</label></div>
            <div><input type="radio" name="rubrica33" id="rubrica333" value="3"
                @if($rubrica33=='3') checked @endif @if($accion=='show') disabled @endif><label for="rubrica333">Aceptable</label></div>
            <div><input type="radio" name="rubrica33" id="rubrica332" value="2"
                @if($rubrica33=='2') checked @endif @if($accion=='show') disabled @endif><label for="rubrica332">Regular</label></div>
            <div><input type="radio" name="rubrica33" id="rubrica331" value="1"
                @if($rubrica33=='1') checked @endif @if($accion=='show') disabled @endif><label for="rubrica331">Malo</label></div>
        </div>
    </div>
</section>
...
<section>
    <div class="container">
        ...
        @php($rubrica41 = old('rubrica41') ?? $modelRubrica->rubrica41)
        <div class="grid-tabla">
            @if ($rubrica==1)
            ...
            <div><input type="radio" name="rubrica41" id="rubrica415" value="5"
                @if($rubrica41=='5') checked @endif @if($accion=='show') disabled @endif><label for="rubrica415">Excelente</label></div>
            <div><input type="radio" name="rubrica41" id="rubrica414" value="4"
                @if($rubrica41=='4') checked @endif @if($accion=='show') disabled @endif><label for="rubrica414">Muy Bueno</label></div>
            <div><input type="radio" name="rubrica41" id="rubrica413" value="3"
                @if($rubrica41=='3') checked @endif @if($accion=='show') disabled @endif><label for="rubrica413">Aceptable</label></div>
            <div><input type="radio" name="rubrica41" id="rubrica412" value="2"
                @if($rubrica41=='2') checked @endif @if($accion=='show') disabled @endif><label for="rubrica412">Regular</label></div>
            <div><input type="radio" name="rubrica41" id="rubrica411" value="1"
                @if($rubrica41=='1') checked @endif @if($accion=='show') disabled @endif><label for="rubrica411">Malo</label></div>
        </div>
        @php($rubrica42 = old('rubrica42') ?? $modelRubrica->rubrica42)
        <div class="grid-tabla">
            @if ($rubrica==1)
            ...
            <div><input type="radio" name="rubrica42" id="rubrica425" value="5"
                @if($rubrica42=='5') checked @endif @if($accion=='show') disabled @endif><label for="rubrica425">Excelente</label></div>
            <div><input type="radio" name="rubrica42" id="rubrica424" value="4"
                @if($rubrica42=='4') checked @endif @if($accion=='show') disabled @endif><label for="rubrica424">Muy Bueno</label></div>
            <div><input type="radio" name="rubrica42" id="rubrica423" value="3"
                @if($rubrica42=='3') checked @endif @if($accion=='show') disabled @endif><label for="rubrica423">Aceptable</label></div>
            <div><input type="radio" name="rubrica42" id="rubrica422" value="2"
                @if($rubrica42=='2') checked @endif @if($accion=='show') disabled @endif><label for="rubrica422">Regular</label></div>
            <div><input type="radio" name="rubrica42" id="rubrica421" value="1"
                @if($rubrica42=='1') checked @endif @if($accion=='show') disabled @endif><label for="rubrica421">Malo</label></div>
        </div>
        @php($rubrica43 = old('rubrica43') ?? $modelRubrica->rubrica43)
        <div class="grid-tabla">
            @if ($rubrica==1)
            ...
            <div><input type="radio" name="rubrica43" id="rubrica435" value="5"
                @if($rubrica43=='5') checked @endif @if($accion=='show') disabled @endif><label for="rubrica435">Excelente</label></div>
            <div><input type="radio" name="rubrica43" id="rubrica434" value="4"
                @if($rubrica43=='4') checked @endif @if($accion=='show') disabled @endif><label for="rubrica434">Muy Bueno</label></div>
            <div><input type="radio" name="rubrica43" id="rubrica433" value="3"
                @if($rubrica43=='3') checked @endif @if($accion=='show') disabled @endif><label for="rubrica433">Aceptable</label></div>
            <div><input type="radio" name="rubrica43" id="rubrica432" value="2"
                @if($rubrica43=='2') checked @endif @if($accion=='show') disabled @endif><label for="rubrica432">Regular</label></div>
            <div><input type="radio" name="rubrica43" id="rubrica431" value="1"
                @if($rubrica43=='1') checked @endif @if($accion=='show') disabled @endif><label for="rubrica431">Malo</label></div>
        </div>
    </div>
</section>
...
<section>
    <div class="container">
        ...
        @php($evaluacion = old('evaluacion') ?? $modelRubrica->evaluacion)
        <div>
        ...
        <div class="campo">
            ...
            <input type="text" name="observaciones" id="observaciones" placeholder="Observaciones"
                value="{{old('observaciones') ?? $modelRubrica->observaciones}}"
                @if($accion=='show') readonly @endif>
        </div>
    </div>
</section>
