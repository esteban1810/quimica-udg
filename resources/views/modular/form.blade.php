...
<div class="w-[min(50rem,90%)] rounded-3xl p-8 bg-white m-auto mt-8">
    ...
    <div class="mb-4">
        ...
        <input type="radio" name="director" value="Sí Tengo" id="siDirector" {{isset($modular->director)&&$modular->director=='Sí Tengo'?'checked':''}}@if(old('director')=='Sí Tengo') checked @endif><label for="siDirector">Sí, hemos trabajado en conjunto</label>
    ...
    <div class="mb-4">
        ...
        <input type="radio" name="isRegistrado" value="Registrado" id="siRegistrado" {{isset($modular->isRegistrado)&&$modular->isRegistrado=='Registrado'?'checked':''}}@if(old('isRegistrado')=='Registrado') checked @endif><label for="siRegistrado">Sí</label>
    ...
    <div class="mb-4">
        ...
        <div><input type="radio" name="PMaEvaluar" value="PM1 Y PM2" id="PM1" {{isset($modular->PMaEvaluar)&&$modular->PMaEvaluar=='PM1 Y PM2'?'checked':''}}@if(old('PMaEvaluar')=='PM1 Y PM2') checked @endif><label for="PM1">PM1. Estructura de la Materia y PM2. Síntesis y Purificación</label></div>
        <div><input type="radio" name="PMaEvaluar" value="PM3 Y PM4" id="PM3" {{isset($modular->PMaEvaluar)&&$modular->PMaEvaluar=='PM3 Y PM4'?'checked':''}}@if(old('PMaEvaluar')=='M3 Y PM4') checked @endif><label for="PM3">PM3. Análisis y Caracterización y PM4: Prevención y solución de Problemas en el área química</label></div>
        <div><input type="radio" name="PMaEvaluar" value="Los 4 módulos" id="PM4" {{isset($modular->PMaEvaluar)&&$modular->PMaEvaluar=='Los 4 módulos'?'checked':''}}@if(old('PMaEvaluar')=='Los 4 módulos') checked @endif><label for="PM4">Los 4 módulos</label></div>
    </div>
    ...
    <div class="mb-4">
        ...
        <div><input type="radio" name="AreaQuimicaTrabajo" id="at1" value="Polímeros" {{isset($modular->AreaQuimicaTrabajo)&&$modular->AreaQuimicaTrabajo=='Polímeros'?'checked':''}}@if(old('AreaQuimicaTrabajo')=='Polímeros') checked @endif><label for="at1">Polímeros</label></div>
        ...
        <div><input type="radio" name="AreaQuimicaTrabajo" id="at3" value="Síntesis de compuestos orgánica u organometálica" {{isset($modular->AreaQuimicaTrabajo)&&$modular->AreaQuimicaTrabajo=='Síntesis de compuestos orgánica u organometálica'?'checked':''}}@if(old('AreaQuimicaTrabajo')=='Síntesis de compuestos orgánica u organometálica') checked @endif><label for="at3">Síntesis de compuestos orgánica u organometálica</label></div>
        <div><input type="radio" name="AreaQuimicaTrabajo" id="at4" value="Bioquímica, Biologia Molecular o Genética" {{isset($modular->AreaQuimicaTrabajo)&&$modular->AreaQuimicaTrabajo=='Bioquímica, Biologia Molecular o Genética'?'checked':''}}@if(old('AreaQuimicaTrabajo')=='Bioquímica, Biologia Molecular o Genética') checked @endif><label for="at4">Bioquímica, Biologia Molecular o Genética</label></div>
        <div><input type="radio" name="AreaQuimicaTrabajo" id="at5" value="Química Analítica e Instrumentación" {{isset($modular->AreaQuimicaTrabajo)&&$modular->AreaQuimicaTrabajo=='Química Analítica e Instrumentación'?'checked':''}}@if(old('AreaQuimicaTrabajo')=='Química Analítica e Instrumentación') checked @endif><label for="at5">Química Analítica e Instrumentación</label></div>
        <div><input type="radio" name="AreaQuimicaTrabajo" id="at6" value="Educación Química" {{isset($modular->AreaQuimicaTrabajo)&&$modular->AreaQuimicaTrabajo=='Educación Química'?'checked':''}}@if(old('AreaQuimicaTrabajo')=='Educación Química') checked @endif><label for="at6">Educación Química</label></div>
        <div><input type="radio" name="AreaQuimicaTrabajo" id="at7" value="Microbiología" {{isset($modular->AreaQuimicaTrabajo)&&$modular->AreaQuimicaTrabajo=='Microbiología'?'checked':''}}@if(old('AreaQuimicaTrabajo')=='Microbiología') checked @endif><label for="at7">Microbiología</label></div>
        <div><input type="radio" name="AreaQuimicaTrabajo" id="at8" value="Química Teórica y computacional" {{isset($modular->AreaQuimicaTrabajo)&&$modular->AreaQuimicaTrabajo=='Química Teórica y computacional'?'checked':''}}@if(old('AreaQuimicaTrabajo')=='Química Teórica y computacional') checked @endif><label for="at8">Química Teórica y computacional</label></div>
        <div><input type="radio" name="AreaQuimicaTrabajo" id="at9" value="Fisicoquímica y Electroquímica" {{isset($modular->AreaQuimicaTrabajo)&&$modular->AreaQuimicaTrabajo=='Fisicoquímica y Electroquímica'?'checked':''}}@if(old('AreaQuimicaTrabajo')=='Fisicoquímica y Electroquímica') checked @endif><label for="at9">Fisicoquímica y Electroquímica</label></div>
    ...
    <div class="mb-4">
        ...
        <div><input type="radio" name="TipoTrabajo" id="innovacion" value="Innovación" {{isset($modular->TipoTrabajo)&&$modular->TipoTrabajo=='Innovación'?'checked':''}}@if(old('TipoTrabajo')=='Innovación') checked @endif><label for="innovacion">Innovación</label></div>
        <div><input type="radio" name="TipoTrabajo" id="aplicacion" value="Aplicación" {{isset($modular->TipoTrabajo)&&$modular->TipoTrabajo=='Aplicación'?'checked':''}}@if(old('TipoTrabajo')=='Aplicación') checked @endif><label for="aplicacion">Aplicación</label></div>
    </div>
    ...
    <div class="mb-4">
        ...
        <div>
            <input type="radio" name="TipoModalidad" value="Titulación" {{isset($modular->TipoModalidad)&&$modular->TipoModalidad=='Titulación'?'checked':''}}@if(old('TipoModalidad')=='Titulación') checked @endif>
...
<div class="w-[min(50rem,90%)] rounded-3xl p-8 bg-white m-auto mt-8">
    ...
    <div class="md:flex">{{--OTRA FORMA DE PONER DOS COLUMNAS--}}
        <div class="mb-4 md:w-1/2">{{--OTRA FORMA DE PONER DOS COLUMNAS--}}
            ...
            <div>
                <input type="radio" name="TipoCongreso" id="TipoCongreso3" value="Presentación de carteles" {{isset($modular->TipoCongreso)&&$modular->TipoCongreso=='Presentación de carteles'?'checked':''}}@if(old('TipoCongreso')=='Presentación de carteles') checked @endif>
        ...
        <div class="mb-4 md:w-1/2">{{--OTRA FORMA DE PONER DOS COLUMNAS--}}
            ...
            <div class="inline-block">
                <input type="radio" name="RecibioBeca" id="RecibioBeca1" value="Sí" {{isset($modular->RecibioBeca)&&$modular->RecibioBeca=='Sí'?'checked':''}}@if(old('RecibioBeca')=='Sí') checked @endif>
...
<div class="w-[min(50rem,90%)] rounded-3xl p-8 bg-white m-auto mt-8">
    ...
    <div class="md:flex">
        <div class="mb-4 md:w-1/2">
            ...
            <div class="inline-block">
                <input type="radio" name="ModalidadTitulacion" id="md" value="Material Didáctico" {{isset($modular->ModalidadTitulacion)&&$modular->ModalidadTitulacion=='Material Didáctico'?'checked':''}}@if(old('ModalidadTitulacion')=='Material Didáctico') checked @endif>
...
<div class="w-[min(50rem,90%)] rounded-3xl p-8 bg-white m-auto mt-8">
    ...
    <div class="campo">
        ...
        <div>
            <input type="radio" name="CasoNoDirector" value="Tengo Director y avances en mi Proyecto, pero NO registré las materias en SIIAU"  {{isset($modular->CasoNoDirector)&&$modular->CasoNoDirector=='Tengo Director y avances en mi Proyecto, pero NO registré las materias en SIIAU'?'checked':''}}@if(old('CasoNoDirector')=='Tengo Director y avances en mi Proyecto, pero NO registré las materias en SIIAU') checked @endif>
            <label for="CasoNoDirector">Tengo Director y avances en mi Proyecto, pero NO registré las materias en SIIAU</label>
        </div>
        <div>
            <input type="radio" name="CasoNoDirector" value="No registré adecuadamente por pares, necesito corregirlo en SIIAU"  {{isset($modular->CasoNoDirector)&&$modular->CasoNoDirector=='No registré adecuadamente por pares, necesito corregirlo en SIIAU'?'checked':''}}@if(old('CasoNoDirector')=='No registré adecuadamente por pares, necesito corregirlo en SIIAU') checked @endif>
